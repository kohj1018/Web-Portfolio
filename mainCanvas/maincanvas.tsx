...
export class MainCanvas {
  ...
  stageWidth: number;
  stageHeight: number;
  constructor(canvas: HTMLCanvasElement, ctx: CanvasRenderingContext2D, main: HTMLElement) {
    this.canvas = canvas;
    this.ctx = ctx;

    this.main = main;
    this.stageWidth = this.main.clientWidth;
    this.stageHeight = this.main.clientHeight;
